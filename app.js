...
function aWhat(){typing(()=>{bubble("Loads of things — each agent does one job perfectly. Popular ones: organising invoices, chasing payments, summarising reports, finding any document instantly, sorting email, tracking stock, and helping with wages. We also build fully custom ones.");typing(()=>{bubble("Which part of your work eats the most time right now?");afterAnswer();},700);},800);}
